    ...
    variants: {
      variant: {
        default: cn(
          ...
          Platform.select({ web: "bg-primary/90" })
        ),
        destructive: cn(
          "bg-destructive shadow-sm shadow-black/5 active:bg-destructive/90 dark:bg-destructive/60",
          Platform.select({
            web: "bg-destructive/90 focus-visible:ring-destructive/20 dark:focus-visible:ring-destructive/40",
          })
        ),
        outline: cn(
          ...
          Platform.select({
            web: "bg-accent dark:bg-input/50",
          })
        ),
        secondary: cn(
          "bg-secondary shadow-sm shadow-black/5 active:bg-secondary/80",
          Platform.select({ web: "bg-secondary/80" })
        ),
        ghost: cn(
          "active:bg-accent dark:active:bg-accent/50",
          Platform.select({ web: "bg-accent dark:bg-accent/50" })
        ),
        link: "",
      },
      size: {
    ...
    variants: {
      variant: {
        ...
        outline: cn(
          ...
          Platform.select({ web: "group-text-accent-foreground" })
        ),
        secondary: "text-secondary-foreground",
        ghost: "group-active:text-accent-foreground",
        link: cn(
          "text-primary group-active:underline",
          Platform.select({ web: "group-underline underline underline-offset-4" })
        ),
      },
      size: {
        default: "",
