        ...
        <DialogPrimitive.Content
          ...
          <DialogPrimitive.Close
            className={cn(
              ...
              Platform.select({
                web: "opacity-100 ring-offset-background transition-opacity focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2 data-[state=open]:bg-accent",
              })
            )}
            hitSlop={12}>
            <Icon
